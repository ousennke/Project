...
const ParamConfigModal: React.FC<ParamConfigModalProps> = ({
  ...
  const handleTypeChange = (newType: ApiParam['type']) => {
    ...
    } else if (newType === 'file' || newType === 'image_base64') {
        ...
        <div className="p-6 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              ) : (formData.type === 'file' || formData.type === 'image_base64') ? (
          ...
          {/* File Conversion Options (only for 'file' type) */}
          {formData.type === 'file' && (
        ...
        <div className="px-6 py-4 bg-gray-50 border-t border-gray-200 flex items-center justify-between">
          ...
          <div className="flex gap-3">
            ...
            <button
              ...
              className={`flex items-center gap-2 px-4 py-2 text-sm font-medium text-white rounded-lg shadow-sm transition-all ${isFileInvalid
