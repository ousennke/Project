        ...
        <div className="flex items-center justify-between mt-4 gap-4">
          <div className="flex items-center bg-gray-100 p-1 rounded-lg shrink-0">
            <button
              ...
              className={`px-3 py-1.5 text-sm font-medium rounded-md transition-all flex items-center gap-2 ${viewMode === 'form' ? 'bg-white text-indigo-600 shadow-sm' : 'text-gray-500 hover:text-gray-700'
                }`}
            >
            ...
            <button
              ...
              className={`px-3 py-1.5 text-sm font-medium rounded-md transition-all flex items-center gap-2 ${viewMode === 'json' ? 'bg-white text-indigo-600 shadow-sm' : 'text-gray-500 hover:text-gray-700'
                }`}
            >
          ...
          <div className="flex items-center gap-3 shrink-0">
            ...
            <button
              ...
              className={`flex items-center gap-2 px-6 py-2 rounded-md font-medium shadow-sm transition-all shrink-0 ${loading
        ...
        {viewMode === 'form' ? (
          <div className="overflow-y-auto p-6 space-y-3 h-full custom-scrollbar">
            {service.params.map((param) => {
              ...
              const type = (param.type as string) === 'image' || param.type === 'image_base64' ? 'file' : param.type;
                      ...
                      <>
                        {type === 'boolean' ? (
                          ...
                          <FileParamInput
                            ...
                            enableUrl={type === 'file' ? (param.enableUrlConversion !== false) : false}
                            enableBase64={param.type === 'image_base64' ? true : (param.enableBase64Conversion !== false)}
          ...
          <div className="relative h-full w-full overflow-hidden min-w-0">
            <div className="absolute top-2 right-4 z-20">
              <button
                ...
                className={`flex items-center gap-1 px-2 py-1 rounded-md border shadow-sm text-xs font-medium transition-colors ${wordWrap
