                       ...
                       {item.preview ? (
                          <div className="relative w-full h-full">
                           ...
                           <div className={`flex flex-col items-center ${item.error ? 'text-red-400' : 'text-gray-400'}`}>
                               ...
                               <span className="text-[9px] mt-1">{item.error ? 'Error' : 'Select'}</span>
                           </div>
                       )}
                       <input 
                          ...
                          <div className="flex gap-2">
                                {showUrlBtn && (
                                    <button
                                        ...
                                        title={item.file ? "Convert to URL" : "Restored Value (URL)"}
                                    >
                                ...
                                {showBase64Btn && (
                                    <button
                                        ...
                                        title={item.file ? "Convert to Base64" : "Restored Value (Base64)"}
                                    >
